...
if sys.platform.startswith("win"):
    ...
    _DATASET_ROOT = '../../../data/dataset/YOMO-half/'
...
nn_opts['ckpt_dir'] = './.zmf-mixFinetune-again/'
nn_opts['ckpt_path'] = '../../tfoptflow-ppm/tfoptflow/zmf-newFinetune9/pwcnet.ckpt-50000'
