...
for i in range(4,8):
    ...
    rawnum = len(glob.glob('../../DimFlow/Learning-to-See-in-the-Dark-master/sid_Sony/%d/*.png'%(foldernum1)))
    for j in range(rawnum):
        image_path1 = '../../DimFlow/Learning-to-See-in-the-Dark-master/sid_Sony/%d/(%d).ARW_out_1.0.png'%(foldernum1,j+1)
        image_path2 = '../../DimFlow/Learning-to-See-in-the-Dark-master/sid_Sony/%d/(%d).ARW_out_1.0.png'%(foldernum2,j+1)
        ...
        names.append(n)
        # add1 = './finalresult/canon/%d_%d.jpg'%(foldernum1,j+1)
        # add2 = './finalresult/canon/%d_%d.jpg'%(foldernum2,j+1)
